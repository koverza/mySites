...
! function (e, t) {
    ...
    b.fn.extend({
        ...
        b.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = b.filter(i, o)), this.length > 1 && (H[e] || b.uniqueSort(o), L.test(e) && o.reverse()), this.pushStack(o)
        }
    }));
    var O = /[^\x20\t\r\n\f]+/g;
    ...
    Y.uid = 1, Y.prototype = {
        ...
        remove: function (e, t) {
            ...
            if (void 0 !== i) {
                if (void 0 !== t) {
                    n = (t = Array.isArray(t) ? t.map(_) : (t = _(t)) in i ? [t] : t.match(O) || []).length;
                    for (; n--;) delete i[t[n]]
        ...
        data: function (e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (o = G.get(r), 1 === r.nodeType && !V.get(r, "hasDataAttrs"))) {
                    for (n = s.length; n--;) s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = _(i.slice(5)), K(r, i, o[i]));
    ...
    function Oe(e, t, n, i) {
        ...
        if (p && (s = (o = we(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = s), s || i)) {
            for (l = (a = b.map(ge(o, "script"), De)).length; u < p; u++) c = o, u !== v && (c = b.clone(c, !0, !0), l && b.merge(a, ge(c, "script"))), n.call(e[u], c, u);
            if (l)
                for (d = a[a.length - 1].ownerDocument, b.map(a, Le), u = 0; u < l; u++) c = a[u], he.test(c.type || "") && !V.access(c, "globalEval") && b.contains(d, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? b._evalUrl && !c.noModule && b._evalUrl(c.src, {
    ...
    b.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(f.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || b.isXMLDoc(e)))
                for (s = ge(a), i = 0, o = (r = ge(e)).length; i < o; i++) Ne(r[i], s[i]);
            if (t)
                if (n)
                    for (r = r || ge(e), s = s || ge(a), i = 0, o = r.length; i < o; i++) He(r[i], s[i]);
                else He(e, a);
    ...
    b.extend({
        ...
        css: function (e, t, n, i) {
            var o, r, s, a = _(t);
            return Ye.test(t) || (t = _e(a)), (s = b.cssHooks[t] || b.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = We(e, t, i)), "normal" === o && t in Ge && (o = Ge[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    ...
    Pt.href = wt.href, b.extend({
        ...
        ajax: function (t, n) {
            ...
            if (y.promise(S), f.url = ((t || f.url || wt.href) + "").replace(Ht, wt.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(O) || [""], null == f.crossDomain) {
                l = g.createElement("a");
                try {
            ...
            if (f.data && f.processData && "string" != typeof f.data && (f.data = b.param(f.data, f.traditional)), It(Nt, f, n, S), c) return S;
    ...
    }, b.isArray = Array.isArray, b.parseJSON = JSON.parse, b.nodeName = $, b.isFunction = h, b.isWindow = v, b.camelCase = _, b.type = w, b.now = Date.now, b.isNumeric = function (e) {
        var t = b.type(e);
...
function openMenu() {
    document.querySelector(".registr-dropdawn__list").classList.toggle("showList")
}
$(selector).on("click", (function () {
    $(selector).removeClass("active"), $(this).addClass("active")
})), $(".slider").slick({
    dots: !0,
    slidesToShow: 5,
    arrows: !1,
    ...
    const e = window.scrollY,
        t = document.querySelector(".toUp");
    e > window.innerHeight ? t.style.visibility = "visible" : e < window.innerHeight && (t.style.visibility = "hidden")
};
